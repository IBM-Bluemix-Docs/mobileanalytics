...
5. Envíe las analíticas de uso registradas al servicio de {{site.data.keyword.mobileanalytics_short}}. Una manera fácil de probar las analíticas consiste en ejecutar el siguiente código en el momento de iniciar la aplicación:
